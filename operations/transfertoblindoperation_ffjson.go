	...
	for {
		...
		case fflib.FFParse_want_value:
			...
			if tok == fflib.FFTok_left_brace || tok == fflib.FFTok_left_bracket || tok == fflib.FFTok_integer || tok == fflib.FFTok_double || tok == fflib.FFTok_string || tok == fflib.FFTok_bool || tok == fflib.FFTok_null {
				...
				case ffjtTransferToBlindOperationAmount:
					goto handle_Amount

				case ffjtTransferToBlindOperationBlindingFactor:
					goto handle_BlindingFactor

				case ffjtTransferToBlindOperationFrom:
					goto handle_From

				case ffjtTransferToBlindOperationOutputs:
					goto handle_Outputs

				case ffjtTransferToBlindOperationFee:
					goto handle_Fee

				case ffjtTransferToBlindOperationnosuchkey:
...
handle_BlindingFactor:
...

	{
		if tok == fflib.FFTok_null {
			...
			err = j.BlindingFactor.UnmarshalJSON(tbuf)
			if err != nil {
				return fs.WrapErr(err)
			}
		}
...

	{
		...
		if tok == fflib.FFTok_null {
			...
			for {
				...
				{
					/* Falling back. type=types.BlindOutput kind=struct */
					tbuf, err := fs.CaptureField(tok)
					if err != nil {
						return fs.WrapErr(err)
					}
